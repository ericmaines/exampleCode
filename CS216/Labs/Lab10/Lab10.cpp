/*
 * Course: CS216-00x
 * Project: Lab 10 (As Project 2 extension)
 * Purpose: Provide extra features for Project 2
...
int main(int argc, char* argv[])
{
    ...
    //           actor name: movie1; movie2; ...; movienN
    ...
    // then display all the co-actors in each of the movies which the user-typed actor was in (excluding the user-typed actor)
    // the user-typed actor name is displayed in all upper case letters
    string inputname;
    cout << "This application helps you find the movies an actor/actress was in (including co-actors):" << endl;
    ...
    {
        // find the set of movies that this actor was in
        ...
        else   // if name is valid
        {
            ...
            cout << validName.toUpper() << " was in: " << endl;
