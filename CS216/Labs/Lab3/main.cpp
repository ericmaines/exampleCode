...
int main(int argc, char** argv)
{
    ...
    if (argc == 1)
    {
	    ...
	    cout << "It's been reversed using a loop: "
		 << to_rev.rev() << endl;
        cout << "It's been reversed using recursion: " << to_rev.rev_recursive()<< endl;            
        cout << "It's been reversed using stacks: " << to_rev.rev_stack() << endl;            
